...
var DateTime = function ()
{
  ...
  {
    if (Date.parse(time1.replace(/-/g, "/")) > Date.parse(
        time2.replace(/-/g, "/")))
    {
      return 1;
    }
    else if (Date.parse(time1.replace(/-/g, "/")) < Date.parse(
        time2.replace(/-/g, "/")))
    {
      return -1;
    }
  ...
  {
    return [31, (this.isLeapYear(year) ? 29 : 28), 31, 30, 31, 30, 31, 31, 30,
      31, 30, 31][month];
  };
    ...
    return pattern.replace(/([a-z])\1*/ig, function (matchStr, group1)
    {
      ...
      switch (group1)
      {
        ...
        case patterns.PATTERN_MONTH: //M
          ...
          replacement = (month < 10 && matchStr.length >= 2) ? "0" + month
              : month;
          break;
        ...
        case patterns.PATTERN_HOUR_OF_DAY0: //H(0~23)
          var hours24 = date.getHours();
          replacement = (hours24 < 10 && matchStr.length >= 2) ? "0" + hours24
              : hours24;
          break;
        case patterns.PATTERN_MINUTE: //m
          var minutes = date.getMinutes();
          replacement = (minutes < 10 && matchStr.length >= 2) ? "0" + minutes
              : minutes;
          break;
        case patterns.PATTERN_SECOND: //s
          var seconds = date.getSeconds();
          replacement = (seconds < 10 && matchStr.length >= 2) ? "0" + seconds
              : seconds;
          break;
        ...
        case patterns.PATTERN_HOUR1: //h(1~12)
          ...
          replacement = (hours12 < 10 && matchStr.length >= 2) ? "0" + hours12
              : hours12;
          break;
  ...
  var handlerDayOfTheYear = function (date)
  {
    ...
    var daysArr = [31, (this.isLeapYear(year) ? 29 : 28), 31, 30, 31, 30, 31,
      31, 30, 31, 30, 31];
