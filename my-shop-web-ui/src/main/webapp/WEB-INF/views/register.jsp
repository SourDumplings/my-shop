...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/ziy.css"/>
</head>
<body>
<!--dengl-->
<div class="yiny">
    <div class="beij_center">
        <div class="dengl_logo">
            <a href="${pageContext.request.contextPath}/index"><img
                    src="${pageContext.request.contextPath}/static/images/logo_1.png"></a>
            <h1>欢迎注册</h1>
        </div>
    </div>
</div>
<div class="beij_center">
    <div class="ger_zhuc_beij">
        <div class="ger_zhuc_biaot">
            <ul>
                <li class="ger_border_color"><a href="${pageContext.request.contextPath}/register">个人注册</a>
                </li>
                <i>丨</i>
                <li><a href="#">申请入驻</a></li>
                <p>我已经注册，现在就<a class="ftx-05 ml10" href="${pageContext.request.contextPath}/login">登录</a>
                </p>
            </ul>
        </div>
        <div class="zhuc_biaod">
            ...
            <div class="reg-items">
                ...
                <div class="check check-border" style="position:relative;left:0">
                    ...
                    <span class="check-phone disable"
                          style="display: none;"><em>60</em>秒后重新获取</span>
                    <a class="check-phone"
                       style="display: none;padding:11px 10px 14px 10px">重新获取验证码</a>
                </div>
                <!--备注————display使用 inline-block-->
                <div class="msg-box">
                    <div class="msg-weak err-tips" style="display:none;">
        ...
        <div class="xiaogg">
            <img src="${pageContext.request.contextPath}/static/images/cdsgfd.jpg">
        </div>
    </div>
</div>
